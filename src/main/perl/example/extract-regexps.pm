...
#     $ARGV = ("/Users/pqc/idea/LinguaFranca-FSE19/data/production-regexes/static-extractors/perl/test.pl")
# }

# my $sourceFile = "/Users/pqc/idea/regex_extract/src/main/perl/example/test.pl";
# extractRegexesWithFile($sourceFile);
...
sub extractRegexesWithFile {
    ...
    eval {
        ...
        #&dumpAll($doc);
        @regexesWithFlags = extractRegexesWithFlags($doc);
    };
    return {
        "fileName" => $sourceFile,
